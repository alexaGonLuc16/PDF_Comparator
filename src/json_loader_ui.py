...
from json_loader import PDFJsonLoader
from json_saver import PDFJsonSaver
...
class JsonLoaderUI(QWidget):
    ...
    def init_ui(self):
        ...
        # Título
        title_label = QLabel("Cargar/Guardar Cambios")
        ...
        # Sección de carga
        load_section_label = QLabel("Cargar Cambios desde JSON")
        ...
        self.apply_changes_button = QPushButton("Aplicar Cambios")
        ...
        # Estado de carga
        self.load_status_label = QLabel("No hay archivos cargados")
    ...
    def apply_changes(self):
        ...
        try:
            ...
            if result_path:
                ...
                # Configurar círculos
                self.pdf_viewer.set_circles(formatted_changes, page_width, page_height)
