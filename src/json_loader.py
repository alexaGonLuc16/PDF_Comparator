...
class PDFJsonLoader:
    ...
    def extract_changes_by_page(self):
        ...
        for page_num, page_data in self.json_data.get("pages", {}).items():
            ...
            if changes:
                changes_by_page[page_num_int] = changes
    ...
    def extract_watermarks(self):
        ...
        return self.json_data.get("watermarks", [])
    ...
    def apply_changes_to_pdf(self, pdf_path, output_path=None):
        ...
        watermarks = self.extract_watermarks()
        ...
        for page_num, highlights in highlights_by_page.items():
            if 0 <= page_num < doc.page_count:
                ...
                for highlight in highlights:
                    x0 = highlight["x0"] * scale_factor
                    y0 = highlight["y0"] * scale_factor
                    x1 = highlight["x1"] * scale_factor
                    y1 = highlight["y1"] * scale_factor
